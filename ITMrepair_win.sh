...
for i in $BASEALL
do
gsmaagents=`grep "$listoffsv" "$i" | grep ' Y ' | grep ' 06 ' | grep -v xw01lfse0003 | grep -v is4_dlu0swww015d | grep -v xw16lcxt0012| grep -v is4_tst-bretswww001 |grep -v xw10lsta0001 | grep -v xw16lapp0179 | grep -v _xw10lwww0828`
echo "$gsmaagents"
osagents=`grep "$listoffsv" "$i" | grep ' Y ' | grep ' NT ' | grep -v xw01lfse0003 | grep -v is4_dlu0swww015d | grep -v is4_tst-bretswww001 | grep -v xw16lcxt0012 | grep -v xw10lsta0001 | grep -v xw16lapp0179 | grep -v _xw10lwww0828`
echo "$osagents"
for o in "$gsmaagents"
do
